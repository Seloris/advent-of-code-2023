...
const realInput = `......644............612.......254..638..............802.................................118.....................................317.691....
...
// input = `......515*357............*...509..205.....*................203..7*........353.....209..........790...81.........................695.....*...
// ........................313............444....................................662..........................956.....714...................935`;
...
const hasAdjacentSymbols = (
  ...
  // line
  if (hasSymbolAround(line, start, end)) {
    return true;
  }

  if (prevLine && hasSymbolAround(prevLine, start, end)) {
    return true;
  }

  if (endLine && hasSymbolAround(endLine, start, end)) {
    return true;
  }
...
const hasSymbolAround = (str: string, start: number, end: number) => {
  const sub = str.substring(start - 1, end + 2);
  for (let i = 0; i < sub.length; i++) {
    if (isSymbol(sub.charAt(i))) {
      return true;
    }
  }
...
const isSymbol = (char: string) =>
  char !== undefined && !Number.isInteger(+char) && char !== '.';
...
export function step1() {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    for (let j = 0; j < line.length; j++) {
      ...
      const isInteger = Number.isInteger(+char);
      ...
      if (
        startIdx !== null &&
        ((isInteger && j === line.length - 1) || !isInteger)
      ) {
        let endIdx = j;
        ...
        const number = +line.substring(startIdx, endIdx + 1);
        const match = hasAdjacentSymbols(
          startIdx,
          endIdx,
          line,
          i > 0 ? lines[i - 1] : null,
